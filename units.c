...
UnitTable unit_table [] = 
  ...
  { angstrom, "angstrom", "angstromgs,ang,angs", "angstrom", "angstroms" }, 
  { ampere, "ampere", "amperes,amp,amps,A", "ampere", "amperes" }, 
  { au, "AU", "au", "atronomical unit", "AUs" }, 
  ...
  { candlepower, "candelpower", "cp", "candlepower (new)" , "candlepower" }, 
  ...
  { usgallon, "usgallon", "usgallons,usgal,usgals", "US pint" , "usgallons" }, 
...
ConvTable conv_table [] = 
  ...
  {  kibibyte, 1, {1, {{ byte, 1, 0}}}, 1024 },
  {  mebibyte, 1, {1, {{ byte, 1, 0}}}, 1048576 },
  {  gibibyte, 1, {1, {{ byte, 1, 0}}}, 1073741824 },
  {  tebibyte, 1, {1, {{ byte, 1, 0}}}, 1099511627776 },
  {  pebibyte, 1, {1, {{ byte, 1, 0}}}, 1125899906842624 },
  {  exbibyte, 1, {1, {{ byte, 1, 0}}}, 1152921504606846976 },
  ...
  {  kibibit, 1, {1, {{ byte, 1, 0}}}, 128 },
  {  mebibit, 1, {1, {{ byte, 1, 0}}}, 131072 },
  {  gibibit, 1, {1, {{ byte, 1, 0}}}, 134217728 },
  {  tebibit, 1, {1, {{ byte, 1, 0}}}, 137438953472 },
  {  pebibit, 1, {1, {{ byte, 1, 0}}}, 140737488355328 },
  {  exbibit, 1, {1, {{ byte, 1, 0}}}, 144115188075855872 },
